...
const TEXT: Record<Lang, Record<string, VitText>> = {
  ...
  en: {
    barbershop: {
      ...
      reviews: [
        { text: "The best beard trim in town, no exaggeration. You feel expected.", author: "Karim B.", meta: "Client for 3 years" },
        { text: "Great vibe, free coffee, and a cut that holds two weeks longer than anywhere else.", author: "Thomas L.", meta: "Google review" },
        { text: "I brought my son for his first cut, they were lovely.", author: "Sophie R.", meta: "Google review" },
      ],
    ...
    onglerie: {
      ...
      reviews: [
        { text: "A cocoon. My nails have never held so well and the place is gorgeous.", author: "Camille D.", meta: "Loyal client" },
        { text: "The nail art is stunningly precise. Léa has a real artist's eye.", author: "Inès M.", meta: "Verified review" },
        { text: "You switch off completely. I leave calm every time.", author: "Margaux T.", meta: "Verified review" },
      ],
    ...
    traiteur: {
      ...
      reviews: [
        { text: "The pâté en croûte is an institution. We order it every New Year's Eve.", author: "The Morel family", meta: "Clients for 12 years" },
        { text: "Order online in the morning, platter ready by noon. Perfect for hosting.", author: "Julien P.", meta: "Google review" },
        { text: "You can feel the craft and the quality. Nothing like the supermarket.", author: "Anne-Claire V.", meta: "Google review" },
      ],
    ...
    restaurant: {
      ...
      reviews: [
        { text: "The lunch value is unbeatable, and everything is made in-house.", author: "Léo F.", meta: "Regular in the area" },
        { text: "Warm service, perfect grower wines. Our Friday canteen.", author: "Nadia S.", meta: "Google review" },
        { text: "You book in two clicks and the table is always ready. Top seasonal cooking.", author: "Marc D.", meta: "Google review" },
      ],
