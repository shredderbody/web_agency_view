...
| [DEVIS_FACTURES.md](./DEVIS_FACTURES.md) | **Devis & factures `/<slug>/quotes`** : un outil par vitrine, identité et catalogue natifs, TVA par métier et par pays, conversion devis → facture, document A4 imprimable |
