...
const ML = {
  fr: {
    ...
    name_l: "Votre nom complet", phone_l: "Votre téléphone",
    name_ph: "Prénom et nom", phone_ph: "06 00 00 00 00",
  ...
  en: {
    ...
    close: "Close",
    done_title: "All set!",
    titles:  { barber: "Book an appointment", onglerie: "Book a treatment", traiteur: "Place an order", resto: "Book a table", plombier: "Request a quote", livraison: "Order for delivery", evenementiel: "Book a consultation" },
    steps:   { barber: ["Service","Slot","Details"], onglerie: ["Treatment","Slot","Details"], traiteur: ["Order","Collection","Details"], resto: ["Date & time","Guests","Details"], plombier: ["Your need","Availability","Details"], livraison: ["Basket","Delivery","Details"], evenementiel: ["Your project","Consultation","Details"] },
    success: { barber: "Request received! Maison Brutus will confirm your appointment by SMS.", onglerie: "Booking received! {business} will confirm by SMS.", traiteur: "Order placed! Maison Ferrand will contact you to confirm collection.", resto: "Table reserved! {business} will confirm by SMS.", plombier: "Request received! Julien Mercier will call back within 24 h with a detailed quote.", livraison: "Order placed! {business} is preparing your food — estimated delivery in 30–40 min.", evenementiel: "Request received! {business} will get back to you within 24 h to arrange your discovery consultation — no obligation." },
    ...
    name_l: "Your full name", phone_l: "Your phone",
    name_ph: "First and last name", phone_ph: "+33 6 00 00 00 00",
