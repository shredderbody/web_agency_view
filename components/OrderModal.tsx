...
const ML = {
  ...
  en: {
    ...
    success: { barber: "Request received! Maison Brutus will confirm your appointment by SMS.", onglerie: "Booking received! {business} will confirm by SMS.", traiteur: "Order placed! Maison Ferrand will contact you to confirm collection.", resto: "Table reserved! {business} will confirm by SMS.", plombier: "Request received! {business} will call back within 24 h with a detailed quote.", livraison: "Order placed! {business} is preparing your food — estimated delivery in 30–40 min.", evenementiel: "Request received! {business} will get back to you within 24 h to arrange your discovery consultation — no obligation." },
