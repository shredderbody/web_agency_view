              ...
              <Reveal delay={180}>
                <div className="hero-visual" style={{ position: "relative", maxWidth: "560px", marginInline: "auto", width: "100%" }}>
                  <div style={{ position: "relative", aspectRatio: "16 / 9", borderRadius: "1.4rem", overflow: "hidden", border: "1px solid var(--border-strong)", boxShadow: "var(--shadow-lg)" }}>
                    <Image src="/studio/hero-desk.webp" alt={t.hero.heroAlt} fill priority unoptimized sizes="(max-width: 1000px) 92vw, 520px" style={{ objectFit: "cover", objectPosition: "center" }} />
                  </div>
        ...
        <section id="metiers" style={{ paddingBlock: "clamp(3rem, 6vw, 5rem)", background: "var(--paper-2)", borderTop: "1px solid var(--border)" }}>
          <div className="wrap">
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(min(100%, 288px), 1fr))", gap: "clamp(1.1rem, 2.5vw, 1.8rem)" }}>
              <Reveal>
                <Link href="/demo/thai-viens-express" className="card card-hover" style={{ display: "flex", flexDirection: "column", overflow: "hidden", height: "100%", outline: "2px solid var(--vermilion)", outlineOffset: "-2px" }}>
                  <div style={{ position: "relative", aspectRatio: "16 / 9" }}>
                    <Image src="/clients/thai-viens-express/photo_00.webp" alt={lang === "en" ? "Thaï Vien Express, Thai restaurant in Courbevoie" : "Thaï Vien Express, restaurant thaïlandais à Courbevoie"} fill unoptimized sizes="(max-width: 700px) 100vw, 380px" style={{ objectFit: "cover", objectPosition: "center" }} />
              ...
              <Reveal delay={80}>
                <Link href="/demo/barbershop-courbevoie" className="card card-hover" style={{ display: "flex", flexDirection: "column", overflow: "hidden", height: "100%", outline: "2px solid var(--vermilion)", outlineOffset: "-2px" }}>
                  <div style={{ position: "relative", aspectRatio: "16 / 9" }}>
                    <Image src="/clients/barbershop-courbevoie/photo_03.webp" alt={lang === "en" ? "Barbershop, barber in Courbevoie" : "Barbershop, barbier à Courbevoie"} fill unoptimized sizes="(max-width: 700px) 100vw, 380px" style={{ objectFit: "cover", objectPosition: "center" }} />
                    <span className="chip" style={{ position: "absolute", top: "0.85rem", left: "0.85rem", display: "inline-flex", alignItems: "center", gap: "0.4rem", background: "var(--vermilion)", color: "#fff" }}>
                      <Star size={13} strokeWidth={0} fill="currentColor" /> {lang === "en" ? "Real client" : "Client réel"}
                    </span>
                  </div>
                  <div style={{ padding: "1.4rem 1.5rem 1.6rem", display: "flex", flexDirection: "column", flex: 1 }}>
                    <h3 className="d-lg" style={{ margin: "0 0 0.35rem" }}>Barbershop · Courbevoie</h3>
                    <p style={{ color: "var(--ink-dim)", margin: "0 0 1.3rem", flex: 1 }}>
                      {lang === "en"
                        ? "An immersive site built from the barbershop's real Google data: services, prices, reviews and photos."
                        : "Un site immersif bâti sur les vraies données Google du salon : prestations, tarifs, avis et photos."}
                    </p>
                    <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: "0.8rem", flexWrap: "wrap", borderTop: "1px solid var(--border)", paddingTop: "1.05rem" }}>
                      <span style={{ fontSize: "0.82rem", color: "var(--ink-muted)", display: "inline-flex", alignItems: "center", gap: "0.3rem" }}>
                        <Star size={13} fill="var(--clay)" stroke="none" /> 4,3 · 23 {lang === "en" ? "reviews" : "avis"} · Courbevoie
                      </span>
                      <span className="link-arrow" style={{ fontSize: "0.95rem" }}>{t.metiers.seePage} <ArrowUpRight size={17} /></span>
                    </div>
                  </div>
              ...
              <Reveal delay={280}>
                <Link href="/demo/texas-plumbing-pros" className="card card-hover" style={{ display: "flex", flexDirection: "column", overflow: "hidden", height: "100%", outline: "2px solid var(--vermilion)", outlineOffset: "-2px" }}>
                  <div style={{ position: "relative", aspectRatio: "16 / 9" }}>
                    <Image src="/clients/texas-plumbing-pros/photo_04.webp" alt={lang === "en" ? "Texas Plumbing Pros, plumber in Gun Barrel City, TX" : "Texas Plumbing Pros, plombier à Gun Barrel City, TX"} fill unoptimized sizes="(max-width: 700px) 100vw, 380px" style={{ objectFit: "cover", objectPosition: "center" }} />
                    <span className="chip" style={{ position: "absolute", top: "0.85rem", left: "0.85rem", display: "inline-flex", alignItems: "center", gap: "0.4rem", background: "var(--vermilion)", color: "#fff" }}>
                      <Star size={13} strokeWidth={0} fill="currentColor" /> {lang === "en" ? "Real client" : "Client réel"}
                    </span>
                  </div>
                  <div style={{ padding: "1.4rem 1.5rem 1.6rem", display: "flex", flexDirection: "column", flex: 1 }}>
                    <h3 className="d-lg" style={{ margin: "0 0 0.35rem" }}>Texas Plumbing Pros</h3>
                    <p style={{ color: "var(--ink-dim)", margin: "0 0 1.3rem", flex: 1 }}>
                      {lang === "en"
                        ? "An immersive site built from the plumber's real Google data: services, emergency 24/7, real job photos and reviews — plus a voice assistant that takes quote requests."
                        : "Un site immersif bâti sur les vraies données Google du plombier : prestations, urgences 24/7, photos de chantier et avis — avec un assistant vocal qui prend les demandes de devis."}
                    </p>
                    <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: "0.8rem", flexWrap: "wrap", borderTop: "1px solid var(--border)", paddingTop: "1.05rem" }}>
                      <span style={{ fontSize: "0.82rem", color: "var(--ink-muted)", display: "inline-flex", alignItems: "center", gap: "0.3rem" }}>
                        <Star size={13} fill="var(--clay)" stroke="none" /> 4,9 · 463 {lang === "en" ? "reviews" : "avis"} · Gun Barrel City, TX
                      </span>
                      <span className="link-arrow" style={{ fontSize: "0.95rem" }}>{t.metiers.seePage} <ArrowUpRight size={17} /></span>
                    </div>
                  </div>
              ...
              <Reveal delay={320}>
                <Link href="/demo/openhouse-canggu" className="card card-hover" style={{ display: "flex", flexDirection: "column", overflow: "hidden", height: "100%", outline: "2px solid var(--vermilion)", outlineOffset: "-2px" }}>
                  <div style={{ position: "relative", aspectRatio: "16 / 9" }}>
                    <Image src="/clients/openhouse-canggu/photo_00.webp" alt={lang === "en" ? "Open House Café, open-air café in Pererenan, Canggu, Bali" : "Open House Café, café en plein air à Pererenan, Canggu, Bali"} fill unoptimized sizes="(max-width: 700px) 100vw, 380px" style={{ objectFit: "cover", objectPosition: "center" }} />
                    <span className="chip" style={{ position: "absolute", top: "0.85rem", left: "0.85rem", display: "inline-flex", alignItems: "center", gap: "0.4rem", background: "var(--vermilion)", color: "#fff" }}>
                      <Star size={13} strokeWidth={0} fill="currentColor" /> {lang === "en" ? "Real client" : "Client réel"}
                    </span>
                  </div>
                  <div style={{ padding: "1.4rem 1.5rem 1.6rem", display: "flex", flexDirection: "column", flex: 1 }}>
                    <h3 className="d-lg" style={{ margin: "0 0 0.35rem" }}>Open House Café</h3>
                    <p style={{ color: "var(--ink-dim)", margin: "0 0 1.3rem", flex: 1 }}>
                      {lang === "en"
                        ? "An immersive site built from the café's real Google data: all-day brunch, healthy bowls, the open-air jungle setting and real reviews — plus a bilingual voice assistant that books tables."
                        : "Un site immersif bâti sur les vraies données Google du café : brunch all-day, bowls healthy, la terrasse jungle en plein air et de vrais avis — avec un assistant vocal bilingue qui réserve les tables."}
                    </p>
                    <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: "0.8rem", flexWrap: "wrap", borderTop: "1px solid var(--border)", paddingTop: "1.05rem" }}>
                      <span style={{ fontSize: "0.82rem", color: "var(--ink-muted)", display: "inline-flex", alignItems: "center", gap: "0.3rem" }}>
                        <Star size={13} fill="var(--clay)" stroke="none" /> 4,6 · 1 053 {lang === "en" ? "reviews" : "avis"} · Canggu, Bali
                      </span>
                      <span className="link-arrow" style={{ fontSize: "0.95rem" }}>{t.metiers.seePage} <ArrowUpRight size={17} /></span>
                    </div>
                  </div>
              ...
              {demos.map((d, i) => (
                <Reveal key={d.slug} delay={(i % 2) * 80}>
                  <Link href={`/demo/${d.slug}`} className="card card-hover" style={{ display: "flex", flexDirection: "column", overflow: "hidden", height: "100%" }}>
                    <div style={{ position: "relative", aspectRatio: "16 / 9" }}>
                      <Image src={d.cover} alt={t.metiers.cardAlt(d.trade, d.business)} fill unoptimized sizes="(max-width: 700px) 100vw, 380px" style={{ objectFit: "cover", objectPosition: "center" }} />
